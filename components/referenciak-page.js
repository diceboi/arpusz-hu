        ...
        <>
            <section className='flex flex-col justify-center items-center w-full overflow-hidden bg-white py-12'>
                ...
                <div className='flex w-11/12 lg:w-8/12 items-center py-8'>
                    ...
                    <div style={{backgroundImage: `url("/zart-cella-7.jpg")`}} className='col-span-1 row-span-1 lg:col-span-2 lg:row-span-3 bg-black h-[250px] min-h-[250px] lg:min-h-[500px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/nyitott-cella-5.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-3 bg-black h-[250px] min-h-[250px] lg:min-h-[500px] rounded-xl bg-cover bg-center' >
                    ...
                    <div style={{backgroundImage: `url("/zart-cella-4.jpg")`}} className=' col-span-1 row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/nyitott-cella-6.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/zart-cella-1.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/nyitott-cella-1.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/zart-cella-2.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/nyitott-cella-2.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/zart-cella-8.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/zart-cella-6-1.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/nyitott-cella-3.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/zart-cella-9.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
                    ...
                    <div style={{backgroundImage: `url("/zart-cella-3.jpg")`}} className='col-span-1 row-span-1 lg:col-span-1 lg:row-span-1 bg-black h-[250px] min-h-[250px] rounded-xl bg-cover bg-center'>
