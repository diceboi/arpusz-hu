    ...
    return(
        <>
            <section className='w-full overflow-hidden'>
                ...
                <div className='flex w-11/12 lg:w-8/12 m-auto items-start flex-col p-4 my-8 bg-gradient-to-r from-[#06A452] to-[#8AECB9] base-tile relative overflow-hidden col-span-2 rounded-xl h-full min-h-[250px] hover:shadow-xl'>
